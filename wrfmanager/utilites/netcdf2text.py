...
Author:		Micha Silver
Date:		1/10/2014
Revisions	12/10/2014 - Added function to compress csv files to tarball
"""
import netCDF4
import numpy as np
...
def text_to_tarball(outdir):
	"""
	Create a tar archive of all precip_csv*.txt files
	"""
	tarname = "precip_csv.tar.gz"
	os.chdir(outdir)
